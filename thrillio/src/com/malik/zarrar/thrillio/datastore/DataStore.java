...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[4] = UserManager.getInstance().createUser(1004, "user4@semanticsquare.com", "test", "Zarrar", "M",
	...
	private static void loadMovies() {
		bookmarks[1][0] = BookmarkManager.getInstance().createMovie(3000, "Citizen Kane", "", 1941,
				new String[] { "Orson Welles", "Joseph Cotten", "Orson Welles" }, new String[] { "Orson Wells" },
				MovieGenre.CLASSICS, 8.5);
		bookmarks[1][1] = BookmarkManager.getInstance().createMovie(3001, "The Grapes of Wrath", "", 1940,
				new String[] { "Henry Fonda", "Jane Darwell", "John Ford" }, new String[] { "Jane Darwell" },
				MovieGenre.CLASSICS, 8.2);
		bookmarks[1][2] = BookmarkManager.getInstance().createMovie(3002, "A Touch of Greatness", "", 2004,
				new String[] { "Albert Cullum", "Leslie Sullivan" }, new String[] { "Mark" }, MovieGenre.DOCUMENTARIES,
				7.3);
		bookmarks[1][3] = BookmarkManager.getInstance().createMovie(3003, "The Big Bang Theory", "Samuel", 2007,
				new String[] { "Kaley Cuoco", "Jim Parsons", "Chuck Lorre", "Bill Prady" }, new String[] { "Pearson" },
				MovieGenre.TV_SHOWS, 8.7);
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004, "Ikiru", "", 1952,
				new String[] { "Takashi Shimura", "Minoru Chiaki", "Akira Kurosawa" }, new String[] { "Akira luffu" },
